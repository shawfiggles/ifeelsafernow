const B777Questions = [
    { q: "🎛️ Where is the Cabin System Control Panel (CSCP) located?", a: "The CSCP is located at **L1 station** above **Purser jump seat** 💺👨‍✈️" },
    { q: "🚨 Where are the smoke detectors located in the CRC?", a: "• One smoke detector is fitted in **each bunk** 🛏️\n• One smoke detector is located in the **aisle between every pair of bunks** 🚶‍♂️🛌🛌🚶‍♀️\n• **Two smoke detectors** are located in the **common area** 🔍🔍" },
