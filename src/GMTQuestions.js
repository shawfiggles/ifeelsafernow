const GMTQuestions = [
    ...
    { q: "True or False? When stabilizing larger objects stuck in the eye, Cabin Crew should secure with bulky pads without applying pressure on the embedded object.", a: "**True**" },
    { q: "What is the colour of the new Zoll AED 3® case?", a: "<span style=\"color: green;\">**Bright green**</span>" },
    { q: "State 3 components of the AED Accessory Kit - attached to the Zoll AED 3® pad package.", a: "• **Paper Towel**\n• **Razor**\n• **Alcohol Wipe**\n• **Gloves**\n• Face shield (not to be used by Cabin Crew)" },
    ...
    { q: "What does the acronym S.T.O.P stand for?", a: "**S**: Signs of normal breathing\n**T**: Turned over to Local Emergency Medical Services\n**O**: Operator (Cabin Crew) is in danger\n**P**: Physician from GMS. Only GMS physician is to be consulted when to stop CPR" },
    { q: "What is the normal pulse rate for children?", a: "**80-100 beats/minute**" },
    { q: "If the casualty is unconscious and breathing, how often should Cabin Crew check for signs of normal breathing?", a: "**Every minute** for **10 seconds**" },
    { q: "In the carriage of expectant mothers, what is the travel limitation for single pregnancy (both uncomplicated and complicated pregnancies)?", a: "Travel is **not allowed** from the beginning of the **37th week** of pregnancy." },
    { q: "State 3 details that must be included in the medical certificate for pregnant passengers.", a: "• Confirmation of **single or multiple pregnancy**\n• **No complications** during the pregnancy\n• **Estimated delivery date**\n• Pregnant passenger is **fit to fly**\n• **Latest date** the doctor/midwife expects the passenger to be fit to travel\n• Issued by a **doctor or midwife**" },
    { q: "Whose permission must be sought before opening the SEMK?", a: "**Purser** (or deputy when applicable)" },
    { q: "In the management of a nosebleed, how often do you check if the bleeding has stopped?", a: "**Every 10 minutes**" },
    ...
    { q: "True or False? Cabin Crew can give the used E-Z spacer or used chamber to the casualty.", a: "**True**" },
